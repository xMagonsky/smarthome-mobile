...
class AutomationPreviewWidget extends StatelessWidget {
  ...
  Widget _buildConditionText(Map<String, dynamic> condition) {
    if (condition['children'] != null) {
      ...
      if (children.isEmpty) {
        return const Text('No conditions', style: TextStyle(fontStyle: FontStyle.italic));
      }
      ...
      return Column(
        ...
        children: [
          ...children.asMap().entries.map((entry) {
            ...
            return Padding(
              padding: EdgeInsets.only(bottom: index < children.length - 1 ? 4 : 0),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  if (index > 0)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: operator == 'AND' ? Colors.green[100] : Colors.orange[100],
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 11,
                          fontWeight: FontWeight.bold,
                          color: operator == 'AND' ? Colors.green[700] : Colors.orange[700],
                        ),
                      ),
                    ),
  ...
  Widget _buildSingleConditionText(Map<String, dynamic> condition) {
    ...
    switch (type) {
      ...
      case 'device':
        final String deviceState = condition['value']?.toString() == 'true' ? 'on' : 'off';
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              if (actions.isEmpty)
                const Text('No actions', style: TextStyle(fontStyle: FontStyle.italic))
              else
